...
<div class="apps">
  ...
  <div class="apps__grid">
    ...
    <div class="apps__card">
      <img class="apps__icon" src="/images/apple-tools-icon.png" alt="apple-tools icon">
      <div class="apps__info">
        <h2 class="apps__name">apple-tools</h2>
        ...
        <div class="apps__tags">
          ...
          <span class="apps__tag">EventKit</span>
          <span class="apps__tag">SQLite</span>
          <span class="apps__tag">Homebrew</span>
          <span class="apps__tag">macOS 14+</span>
        </div>
        <div class="apps__links">
          <a class="apps__link" href="https://github.com/danielhopkins/apple-tools" target="_blank" rel="noopener noreferrer">
          ...
          <a class="apps__link" href="/posts/2026-07-30-apple-tools-six-apple-apps-one-command-line/">
